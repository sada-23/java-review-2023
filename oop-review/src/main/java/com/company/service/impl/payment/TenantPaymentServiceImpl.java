...
import com.company.exception.InvalidPaymentStrategyException;
...
import com.company.service.impl.initialization.HybridPosInitializationServiceImpl;
import com.company.service.impl.initialization.TenantPosInitializationServiceImpl;
import com.company.service.impl.selection.HybridPosSelectionServiceImpl;
import com.company.service.impl.selection.TenantPosSelectionServiceImpl;
...
import static com.company.constant.StaticConstants.COMPANY_PAYMENT_LIST;
...
public class TenantPaymentServiceImpl implements PaymentService {
    ...
    public void initPaymentRecord(AuthRequest authRequest, UUID orderId){
        ...
        COMPANY_PAYMENT_LIST.add(payment);
    }
